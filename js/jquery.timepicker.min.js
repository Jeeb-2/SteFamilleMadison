      ...
      (e.TimePicker.prototype = {
        ...
        open: function (t) {
          ...
          switch (
            ...
            (t.rebuild || !t.items || r) &&
              (t.items = i._items(t, r ? n : null)),
            (t.rebuild || i.instance !== t || r) &&
              (e.fn.jquery < "1.4.2"
                ? (i.viewport.children().remove(),
                ...
                : (i.viewport.children().detach(), i.viewport.append(t.items))),
            (t.rebuild = !1),
            i.container
              .removeClass(
          ...
          i.container.hasClass("ui-timepicker-no-scrollbar") ||
            t.options.scrollbar ||
            (i.container.addClass("ui-timepicker-no-scrollbar"),
            i.viewport.css({ paddingRight: 40 }));
          ...
          return (
            i.instance === t &&
              (i.container
                ...
                .hide(),
              i.ui.scrollTop(0),
              i.ui.children().removeClass("ui-state-hover")),
            e(document).unbind(
